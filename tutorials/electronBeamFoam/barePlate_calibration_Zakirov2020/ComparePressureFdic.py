...
print("Calibration pressure-preconditioner A/B")
print("  baseline = PCG + DIC")
print("  probe    = PCG + FDIC")
...
print("  - pressure and total wall time should decrease;");
print("  - global cells and source conservation should remain effectively unchanged;")
print("  - reject if pressure convergence/runtime stability degrades.")
